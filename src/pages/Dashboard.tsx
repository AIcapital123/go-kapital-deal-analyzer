...
const Dashboard = () => {
  ...
  return (
    <>
      <PageHeader
        title="Deal Analyzer"
        subtitle="Upload, review, and analyze business loan files."
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <SummaryCard label="Awaiting Analysis" value={awaiting} helper="Ready, processing, or needs review" icon={Clock3} tone="amber" />
        <SummaryCard label="Completed Analyses" value={completed} helper="Analysis completed and available" icon={CheckCircle2} tone="green" />
      </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Select value={status} onValueChange={(value) => setStatus(value as DealStatus | "all")}>
              ...
              <SelectContent>
                ...
                <SelectItem value="ready">Ready to Analyze</SelectItem>
